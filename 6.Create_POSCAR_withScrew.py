...
with open("4.Rhombus_with_Screw.lam","r") as infile:
...
with open("4.Rhombus_with_Screw_shifted.lam","r") as infile:
    with open("Rhombus_POSCAR_withScrew_shifted","w") as outfile:     
	temp=infile.readline()
	temp=infile.readline()
