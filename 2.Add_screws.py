...
"""
Shift dislocation in y direction by 1
"""
with open("1.initial_structure.lam","r") as infile:
    with open("2.square_with_dislocations_shifted.lam","w") as outfile:     
	...
	ly=yhi-ylo
	dly=ly/20.0
	screw1=[(yhi-ylo)/4.0+dly,(zhi-zlo)/4.0]
	screw2=[(yhi-ylo)/4.0*3+dly,(zhi-zlo)/4.0]
	screw3=[(yhi-ylo)/4.0*3+dly,(zhi-zlo)/4.0*3]
	screw4=[(yhi-ylo)/4.0+dly,(zhi-zlo)/4.0*3]
